...
#app.config['SQLALCHEMY_DATABASE_URI'] = f'postgresql://flashcards_rsx3_user:{postgres_password}@dpg-cp2uddkf7o1s73bnvcgg-a.frankfurt-postgres.render.com/flashcards_rsx3'
app.config['SQLALCHEMY_DATABASE_URI'] = f'postgresql://flashcards_rsx3_user:{postgres_password}@dpg-cp2uddkf7o1s73bnvcgg-a.frankfurt-postgres.render.com:5432/flashcards_rsx3?sslmode=require'
